            ...
            <div class="col-md-11 col-md-offset-1 wow animated fadeInRight">
                <div class="welcome-block">
                    ...
                    <div class="message-body">
                        ...
                        <p>Fantasy Marketing has the ability to procure accurate examples of desirable, limited edition exotic automobiles through a relationship with an automotive design team which guarantees an abundance of interest from its target audience – the general public as well as car enthusiasts. Regardless of the level of knowledge of exotic cars which raffle participants have, the examples offered excite all who see it.</p>
                    </div>
                </div>
            </div>
        </div>
